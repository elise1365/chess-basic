...
// this function is called everytime  move is made, to check if the king has been taken
...
// used to reset the board - adds all the items back to the box with the starting locations
